...
module alu_4bit_comprehensive_tb;
    ...
    initial begin
        ...
        // Group 7: AND
        $display("\n▶ AND Operations:");
        test_alu(4'b1010, 4'b0101, 4'b0100, 1'b0, 4'b0000, 1'b0, "1010 AND 0101 = 0000");
        test_alu(4'b1111, 4'b0101, 4'b0100, 1'b0, 4'b0101, 1'b0, "1111 AND 0101 = 0101");
        test_alu(4'b1111, 4'b1111, 4'b0100, 1'b0, 4'b1111, 1'b0, "1111 AND 1111 = 1111");
        test_alu(4'b0000, 4'b1111, 4'b0100, 1'b0, 4'b0000, 1'b0, "0000 AND 1111 = 0000");

        // Group 8: OR
        $display("\n▶ OR Operations:");
        test_alu(4'b1010, 4'b0101, 4'b0101, 1'b0, 4'b1111, 1'b0, "1010 OR 0101 = 1111");
        test_alu(4'b0000, 4'b0100, 4'b0101, 1'b0, 4'b0100, 1'b0, "0000 OR 0100 = 0100");
        test_alu(4'b1000, 4'b0100, 4'b0101, 1'b0, 4'b1100, 1'b0, "1000 OR 0100 = 1100");
        test_alu(4'b0000, 4'b0000, 4'b0101, 1'b0, 4'b0000, 1'b0, "0000 OR 0000 = 0000");

        // Group 9: XOR
        $display("\n▶ XOR Operations:");
        test_alu(4'b1010, 4'b0101, 4'b0110, 1'b0, 4'b1111, 1'b0, "1010 XOR 0101 = 1111");
        test_alu(4'b1111, 4'b1111, 4'b0110, 1'b0, 4'b0000, 1'b0, "1111 XOR 1111 = 0000");
        test_alu(4'b1010, 4'b1010, 4'b0110, 1'b0, 4'b0000, 1'b0, "1010 XOR 1010 = 0000");
        test_alu(4'b0101, 4'b1010, 4'b0110, 1'b0, 4'b1111, 1'b0, "0101 XOR 1010 = 1111");

        // Group 10: NOT
        $display("\n▶ NOT Operations:");
        test_alu(4'b1010, 4'bxxxx, 4'b0111, 1'b0, 4'b0101, 1'b0, "NOT 1010 = 0101");
        test_alu(4'b0000, 4'bxxxx, 4'b0111, 1'b0, 4'b1111, 1'b0, "NOT 0000 = 1111");
        test_alu(4'b1111, 4'bxxxx, 4'b0111, 1'b0, 4'b0000, 1'b0, "NOT 1111 = 0000");
        test_alu(4'b0001, 4'bxxxx, 4'b0111, 1'b0, 4'b1110, 1'b0, "NOT 0001 = 1110");
